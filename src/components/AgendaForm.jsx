...
function AgendaForm({ onBack }) {
  ...
  const handleChange = (e) => {
    ...
    if (name === 'tipo_cliente') { newState = { ...newState, interesado_tipo_documento: '', interesado_documento: '' }; }
