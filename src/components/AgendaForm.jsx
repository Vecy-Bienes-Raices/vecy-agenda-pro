...
function AgendaForm({ onBack }) {
  ...
  return (
    <form noValidate onSubmit={handleSubmit}>
      ...
      {!consentGiven && (<fieldset className="border-t-2 border-soft-gold pt-6 mb-10 transition-opacity duration-500"><legend className="text-xl font-semibold text-off-white px-2 -ml-2">Consentimiento de Datos</legend><p className="text-off-white/80 mt-2">¿Nos autorizas el uso de tus datos? Indícanos si estás de acuerdo en que Vecy Bienes Raíces recopile y utilice tus datos única y exclusivamente para esta solicitud, de acuerdo con nuestra Política de Privacidad y nuestros Términos y Condiciones. Te sugerimos leerlos antes de comenzar.</p><div className="mt-6 flex gap-4"><button type="button" onClick={handleConsent} className="bg-esmeralda hover:bg-green-500 text-white font-bold py-2 px-6 rounded-lg transition-all">Sí, autorizo</button><button type="button" className="bg-red-600 hover:bg-red-500 text-white font-bold py-2 px-6 rounded-lg transition-all">NO</button></div></fieldset>)}
