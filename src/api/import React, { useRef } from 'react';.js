...
const firmaJaniUrl = '/Jani.1.png'; // IMPORTANTE: Coloca la imagen de la firma como 'Jani.1.png' en la carpeta /public
      ...
      <div ref={contractRef} className="bg-white text-grafito p-8 md:p-12 rounded-lg shadow-lg font-sans max-w-4xl mx-auto">
        <header className="flex justify-between items-center border-b-2 border-gray-300 pb-4 mb-8">
          ...
          <div className="text-right">
            <h1 className="text-2xl font-bold font-serif text-volcanic-black">Contrato de Colaboración</h1>
            <p className="text-sm text-gray-500">Acuerdo de Puntas Compartidas</p>
          </div>
        </header>

        <section className="mb-6 text-sm leading-relaxed">
          <p className="mb-4">Entre los suscritos a saber, por una parte, <strong>VECY BIENES RAÍCES S.A.S.</strong>, sociedad comercial legalmente constituida, identificada con NIT 901.XXX.XXX-X, representada en este acto por <strong>JANI ALVES SOUZA</strong>, mayor de edad, identificada con la cédula de ciudadanía No. 41.057.506, quien en adelante se denominará <strong>VECY</strong>; y por otra parte, <strong>{formData.solicitante_nombre}</strong>, mayor de edad, identificado(a) con {formData.solicitante_tipo_documento} No. {formData.solicitante_numero_documento}, quien en adelante se denominará <strong>EL AGENTE</strong>, hemos convenido celebrar el presente contrato de colaboración, que se regirá por las siguientes cláusulas:</p>
        </section>
        ...
        <div className="space-y-6 text-sm leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-none ml-4 mt-2 space-y-1">
              <li><strong>VECY:</strong> Correo electrónico: <a href="mailto:info@vecy.com.co" className="text-blue-600 hover:underline">info@vecy.com.co</a>, Celular: +57 3XX XXX XXXX.</li>
              <li><strong>EL AGENTE:</strong> Correo electrónico: <a href={`mailto:${formData.solicitante_email}`} className="text-blue-600 hover:underline">{formData.solicitante_email}</a>, Celular: {formData.solicitante_celular}.</li>
            </ul>
          </section>
        </div>
          ...
          <div className="flex flex-col md:flex-row justify-around items-start gap-12">
            ...
            <div className="flex-1 text-center flex flex-col h-32">
              ...
              <div className="border-t border-grafito pt-2 text-xs">
                ...
                <p>C.C. 41.057.506</p>
                <p>Representante Legal - VECY BIENES RAÍCES S.A.S.</p>
              </div>
            </div>
            ...
            <div className="flex-1 text-center flex flex-col h-32">
              <div className="flex-grow flex items-center justify-center">
                {formData.metodoFirma === 'virtual' && formData.firma_virtual_base64 ? (
                  <img src={formData.firma_virtual_base64} alt="Firma del Agente" className="max-h-20 bg-gray-50" />
                ) : (
                  <div className="h-full w-full flex items-center justify-center text-gray-400 italic">(Firma Digital Adjunta)</div>
                )}
              </div>
              <div className="border-t border-grafito pt-2 text-xs">
